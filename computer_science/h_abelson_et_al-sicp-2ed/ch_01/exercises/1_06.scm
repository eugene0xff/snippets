...
;; why 'if' needs to be provided as a special form.
;; "Why can't I just define it as an ordinary procedure in terms of cond?"
;; she asks.
;; Alyssa's friend Eva Lu Ator claims this cen indeed be done,
;; and she defines a new version of it:
;;
...
;; (The evaluator must always calculate the 'else' value
